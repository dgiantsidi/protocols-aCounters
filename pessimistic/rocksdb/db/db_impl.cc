...
DBImpl::DBImpl(const DBOptions& options, const std::string& dbname,
  ...
  asynch_counter->setCachePtr(&unstablePeriodCache);
}
...
DBImpl::~DBImpl() {
    std::cout << "Number of commit-waits: "<< num_commit_waits << "\n";
    std::cout << "Number of avoided-commit-waits: " << avoided_commit_waits << "\n";
    std::cout << "Number of commits: "<< num_commit << "\n";
    std::cout << "Stable Counter Value: "<< asynch_counter->stable_value() << " " << asynch_counter->current_value() << "\n";
    delete asynch_counter;
