...
class AsynchCounters {
    public:
        ...
        AsynchCounters() {
            ...
            wal_val->incremented_val = (id != -1) ? id : 0;
            /**
        ...
        /**
         * This is executed by the agent thread and continuously checks for
         * updates in the software counters. When a change is identified the
