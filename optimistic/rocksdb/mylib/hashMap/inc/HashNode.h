            ...
            {}
                ...
                bool insert(const K &key, const V &value)
                {
                    ...
                    {   
                        ...
                        // with a timestamp at least equal to ours
                        // return false, should commit-wait
                        const V prev_val = node->getValue();
                        if (prev_val >= value)
                            retVal = false;
                        else {
                            // key was here of some previous timestamp
                            // it has expired
                            node->setValue(value);
                            retVal = true; 
                        }
                    ...
                    return retVal; // returns true if the append was successful (inserted the key)
